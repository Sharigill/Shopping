                          ...
                          <div class="row">
                            ...
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="password" value="" name="ucpass" placeholder="" id="CustomerPassword" class="">                        	
                                </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="text-center col-12 col-sm-12 col-md-12 col-lg-12">
                                <button type="submit" class="btn mb-3"  name='btn'>Create</button>
                            </div>
                         </div>
                     </form>
                    </div>
...
if (isset($_POST['btn'])) {
    ...
    $query = mysqli_query($mysqli,"INSERT INTO `register`(`fname`, `lname`, `emaill`, `pass`) VALUES ('$name','$lname','$email','$cpassword')");
    if($query){
