                        ...
                        <div class="grid-products grid--view-items">
                            ...
                            <?php 
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM products WHERE CONCAT(pro_name,pro_discription,pro_price,pro_QTY,pro_image,categorey,pro_name,product_id) LIKE '%$filtervalues%' ";
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-2 item">
                                    ...
                                    <div class="product-image">
                                        <!-- start product image -->
                                        <a href="short-description.php?proid=<?php echo $items['product_id'] ?>">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload"  src="../complete/adminpanelpro/srtdash/img/<?php echo $items['pro_image']?>" alt="image" title="product">
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" src="../complete/adminpanelpro/srtdash/img/<?php echo $items['pro_image']?>" alt="image" title="product">
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                    ...
                                    <div class="product-details text-center">
                                        ...
                                        <div class="product-name">
                                            <a href="#"><?php echo $items["pro_name"]?></a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                                            <span class="price"><?php echo $items["pro_price"]?></span>
                                        </div>
                                        <!-- End product price -->
