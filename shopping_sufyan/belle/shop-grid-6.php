    ...
    <div id="page-content">
    	...
    	<div class="collection-header">
			<div class="collection-hero">
        		<div class="collection-hero__image"><img class="blur-up lazyload" data-src="product-display-backdrop-with-winners-podium-design-for-school-stationery-placement-powerpoint-background_a91c82e06a__960_540.avif" src="product-display-backdrop-with-winners-podium-design-for-school-stationery-placement-powerpoint-background_a91c82e06a__960_540.avif" alt="Men" title="Men" /></div>
        ...
        <div class="container">
            ...
            <div class="col-md-12">
				...
				if(isset($_GET['cat_id'])){
					$id = $_GET['cat_id'];
					$query=mysqli_query($mysqli,"select * from products where categorey=$id");
				...
				?>
                                <div class="col-6 col-sm-6 col-md-4 col-lg-2 item">
                                    ...
                                    <div class="product-image">
                                        <!-- start product image -->
                                        <a href="short-description.php?proid=<?php echo $pro[7] ?>">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload"  src="../complete/adminpanelpro/srtdash/img/<?php echo $pro[4]?>" alt="image" title="product">
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" src="../complete/adminpanelpro/srtdash/img/<?php echo $pro[4]?>" alt="image" title="product">
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                    ...
                                    <div class="product-details text-center">
                                        ...
                                        <div class="product-name">
                                            <a href="#"><?php echo $pro[6]?></a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                                            <span class="price"><?php echo $pro[2]?></span>
                                        </div>
                                        <!-- End product price -->
                                ...
                                ?>
                                <?php 
					$pro=mysqli_query($mysqli,"select * from products");
					...
					?>
                                <div class="col-6 col-sm-6 col-md-4 col-lg-2 item">
                                    ...
                                    <div class="product-image">
                                        <!-- start product image -->
                                        <a href="short-description.php?proid=<?php echo $pro1[7] ?>">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload" src="../complete/adminpanelpro/srtdash/img/<?php echo $pro1[4]?>" alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload"  src="../complete/adminpanelpro/srtdash/img/<?php echo $pro1[4]?>" alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                        ...
                                        <!-- Start product button -->
                                        <form class="variants add" action="#" onclick="window.location.href='cart.php'"method="post">
                                            <button class="btn btn-addto-cart" type="button">View cart</button>
                                        </form>
                                        <div class="button-set">
                                    ...
                                    <div class="product-details text-center">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="#"><?php echo $pro1[6]?></a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                                            <span class="price"><?php echo $pro1[2]?></span>
                                        </div>
                                        <!-- End product price -->
