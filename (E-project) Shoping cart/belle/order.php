...
include('asside.php')?>
    ...
    <div id="page-content" style="margin-top: 6%;">
        ...
        <div class="container">
        <form id="orderForm" action="receipt.php">
    <div class="cart__footer">
        <div class="cart-note">
            <div class="solid-border">
                <h5><label for="orderInput" class="cart-note__label small--text-center">Add your order_id and Search Your Order</label></h5>
                <input type="number" id="orderInput" name="order_id" placeholder="Enter your order ID">
            </div>
        </div>
        <div class="solid-border">
...
<script>
    document.getElementById('orderForm').addEventListener('submit', function(event) {
        ...
        if(orderId) {
            // Append the order ID as a query parameter to the form action
            window.location.href = `${this.action}?at_id=${orderId}`;
        } else {
            alert('Please enter an order ID'); // Optional: Show an alert if the input is empty
        }
    });
</script>
