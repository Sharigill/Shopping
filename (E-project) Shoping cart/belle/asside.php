...
<div class="pageWrapper">
	...
	<div class="search">
        ...
        <form action="shopsearch.php" class="search-bar__form" method="GET">
                                    <div class="input-group mb-3">
                                        <input type="text"class="search__input" name="search" required value="<?php if(isset($_GET['search'])){echo $_GET['search']; } ?>"  autocomplete="off" class="form-control" aria-label="Search" placeholder="Search entire store...">
...
?>
    ...
    <li>
        <a href="home7-shoes.php">WELCOME‎ ‎ <?php echo $_SESSION['username']?></a>
    </li>
                ...
                <div class="col-2 col-sm-3 col-md-3 col-lg-8">
                	...
                	<nav class="grid__item" id="AccessibleNav"><!-- for mobile -->
                        <ul id="siteNav" class="site-nav medium center hidearrow">
                            <li class="lvl1 parent megamenu"><a href="home7-shoes.php">Home <i class="anm anm-angle-down-l"></i></a>
                            </li>
                            <li class="lvl1 parent megamenu"><a href="shop-grid-6.php">Product<i class="anm anm-angle-down-l"></i></a>
                            	
                            </li>
                        <li class="lvl1 parent megamenu"><a href="order.php">Search Order<i class="anm anm-angle-down-l"></i></a>
                        ...
                        <li class="lvl1 parent dropdown"><a href="#">Pages <i class="anm anm-angle-down-l"></i></a>
                          <ul class="dropdown">
							...
							<li><a href="cart.php" class="site-nav">Checkout</a></li>
                    ...
                    <div class="col-4 col-sm-3 col-md-3 col-lg-2">
                        <div class="site-cart">
                            <a href="#;" class="site-header__cart" title="Cart">
                                ...
                                <span id="CartCount" class="site-header__cart-count" data-cart-render="item_count" data-notify="
						<?php 
						$count=0;
...
echo $count;
						...
						?>
                                    <li class="item">
                                        <a class="product-image" href="#">
                                            <img  src="../complete/adminpanelpro/srtdash/img/<?php echo $val['pimage']?>" alt="3/4 Sleeve Kimono Dress" title="" />
                                        </a>
                                        <div class="product-details">
                                            <a href="#" class="remove"><i class="anm anm-times-l" aria-hidden="true"></i></a>
                                            <a href="#" class="edit-i remove"><i class="anm anm-edit" aria-hidden="true"></i></a>
                                            <a class="pName" href="cart.html"><?php echo $val['pname']?></a>
                                            ...
                                            <div class="priceRow">
                                                <div class="product-price">
                                                    <span class="money"> <?php echo $val['pqty']. 'x'. $val['pprice']?></span>
                                                </div>
                                             </div>
                                        </div>
                                    </li>
					...
					?>
                                <div class="total">
                                    <div class="total-in">
                                        <span class="label">Cart Subtotal:</span><span class="product-price"><span class="money"><?php echo $count?></span></span>
                                    </div>
